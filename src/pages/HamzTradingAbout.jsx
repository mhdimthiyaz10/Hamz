...
const HamzTradingAbout = () => {
    ...
    return (
        <div className="w-full min-h-screen bg-[#0A0A0A] text-white font-sans selection:bg-[#F47920] selection:text-white relative flex flex-col overflow-x-hidden">
            ...
            ></div>
            {/* Purple Glow Left */}
            <div className="absolute top-[-10%] -left-[10%] w-[60%] h-[1000px] rounded-full bg-[radial-gradient(circle_at_center,rgba(60,10,50,0.4),transparent_60%)] blur-3xl pointer-events-none z-0"></div>
            {/* Cyan Glow Right */}
            <div className="absolute top-[-10%] -right-[10%] w-[60%] h-[1000px] rounded-full bg-[radial-gradient(circle_at_center,rgba(5,60,70,0.4),transparent_60%)] blur-3xl pointer-events-none z-0"></div>

            {/* Subtle Wavy Lines (Optional but matching the feel) */}
            <div className="absolute top-0 left-0 right-0 h-[800px] pointer-events-none z-0 opacity-10"
                style={{
            ...
            <nav className="w-full flex justify-between items-center py-8 px-6 md:px-12 lg:px-24 xl:px-40 z-50 relative">
                ...
                <div className="flex-1 flex justify-end">
                    ...
                    <div className="hidden md:flex items-center gap-10 text-[12px] md:text-[13px] font-medium tracking-wide uppercase text-gray-300">
                        ...
                        <Link to="/hamz-trading/about" className="px-8 py-3 bg-white text-black rounded-full hover:bg-gray-100 transition-colors shadow-lg whitespace-nowrap">
                            About Us
                        </Link>
            ...
            {isMobileMenuOpen && (
                <div className="absolute top-24 left-4 right-4 bg-[#12111A]/95 backdrop-blur-xl border border-white/5 rounded-3xl p-8 z-40 flex flex-col gap-6 shadow-[0_20px_50px_rgba(0,0,0,0.6)] md:hidden">
                    ...
                    <Link to="/hamz-trading/about" onClick={() => setIsMobileMenuOpen(false)} className="text-white text-[15px] uppercase tracking-widest font-normal hover:text-[#F47920] transition-colors pb-2 border-b border-white/5">About Us</Link>
            ...
            <main className="flex-grow flex flex-col z-10 relative">
                ...
                <div className="w-full px-8 md:px-16 xl:px-32 flex items-center gap-6 mt-8 mb-12 max-w-[1400px] mx-auto text-[18px] md:text-[22px] font-extralight tracking-widest text-gray-400">
                    ...
                    <div className="w-16 h-[2px] bg-[#F47920]"></div>
                ...
                <div className="flex flex-col md:flex-row gap-12 lg:gap-16 items-center px-0 md:px-0 xl:px-0">
                    ...
                    <div className="w-full md:flex-1 px-8 md:px-0 md:pl-24 xl:pl-48 flex justify-center md:justify-start">
                        <div
                            className="w-full max-w-[400px] aspect-[4/5] md:aspect-square relative bg-cover bg-center overflow-hidden transform translate-x-4 md:translate-x-8"
                            style={{
                    ...
                    <div className="flex flex-col flex-1 px-8 md:px-0 md:pr-16 xl:pr-32 h-full justify-center">
                        <h2 className="text-[22px] md:text-[30px] leading-tight font-medium text-white max-w-none tracking-wide">
                            <span className="md:whitespace-nowrap">
                                <span className="text-[#F47920]">"</span>With honesty and integrity in every transaction{' '}
                            </span>
                            <br className="hidden md:block" />
                            <span className="md:whitespace-nowrap">
                                trading with purpose, guided by values.<span className="text-[#F47920]">"</span>
                            </span>
                        </h2>
                        ...
                        <div className="mt-16 flex flex-col items-start w-full max-w-[800px] text-left ml-6 md:ml-12">
                            <h4 className="text-[26px] md:text-[32px] text-white font-normal tracking-wide leading-none" dir="rtl" style={{ fontFamily: "Arial, Tahoma, sans-serif", wordSpacing: "6px" }}>
                                مؤسسة حسين حبيب بن <span className="text-[#F47920]">يوسف السيهاتي</span> <span className="text-[#F47920]">للتجارة</span>
                            </h4>
                            <p className="text-[14px] md:text-[17px] text-white mt-1 font-bold tracking-[0.1em]" style={{ fontFamily: "Inter, sans-serif" }}>
                                HUSSAIN HABEEB BIN <span className="text-[#F47920]">YOUSIF AL SAIHATI</span> <span className="text-[#F47920]">TRADING</span>
                            </p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                        {['Project Support', 'Personal Protective Solutions', 'Oil Field Supply Services', 'Industrial Equipment &\nAccessories'].map((title, idx) => (
                            <div key={idx} className="bg-[#12111A] rounded border border-white/5 relative p-6 min-h-[90px] flex items-center justify-center text-center group shadow-[0_0_15px_rgba(76,29,149,0.05)] hover:border-white/10 transition-all duration-300 hamz-flowing-glow">
                                {/* Top inner highlight */}
                                <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-[#F47920]/40 to-transparent opacity-80 z-20"></div>
                                {/* Inner glow */}
