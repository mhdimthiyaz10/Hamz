...
const HamzTradingAbout = () => {
    ...
    return (
        <div className="w-full min-h-screen bg-[#0A0A0A] text-white font-sans selection:bg-[#FF7549] selection:text-white relative flex flex-col overflow-x-hidden">
            ...
            {isMobileMenuOpen && (
                <div className="absolute top-24 left-4 right-4 bg-[#12111A]/95 backdrop-blur-xl border border-white/5 rounded-3xl p-8 z-40 flex flex-col gap-6 shadow-[0_20px_50px_rgba(0,0,0,0.6)] md:hidden">
                    ...
                    <Link to="/hamz-trading/about" onClick={() => setIsMobileMenuOpen(false)} className="text-white text-[15px] uppercase tracking-widest font-normal hover:text-[#FF7549] transition-colors pb-2 border-b border-white/5">About Us</Link>
            ...
            <main className="flex-grow flex flex-col z-10 relative">
                ...
                <div className="flex flex-col md:flex-row gap-12 lg:gap-16 items-center px-0 md:px-0 xl:px-0">
                    ...
                    <div className="w-full md:flex-1 px-8 md:px-0 md:pl-16 xl:pl-32 flex justify-center md:justify-start">
                        <div
