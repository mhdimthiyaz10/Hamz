...
const LightPillar = ({
    ...
    `;
      ...
      void main() {
        ...
        vec3 col = vec3(0.0);
        float t = 0.1;
        float currentPillarWidth = uPillarWidth * (1.0 + uHover * 0.35);
        ...
        for(int i = 0; i < MAX_ITER; i++) {
          ...
          float bound = length(p.xz) - currentPillarWidth;
          float k = 4.0;
        ...
        float widthNorm = currentPillarWidth / 3.0;
        col = tanh(col * uGlowAmount / widthNorm);
        
        col -= fract(sin(dot(gl_FragCoord.xy, vec2(12.9898, 78.233))) * 43758.5453) / 15.0 * uNoiseIntensity;
        
        gl_FragColor = vec4(col * uIntensity * (1.0 + uHover * 1.8), 1.0);
      }
    `;
        ...
        const animate = currentTime => {
            ...
            if (deltaTime >= frameTime) {
                ...
                hoverProgress.current += ((isHovering.current ? 1.0 : 0.0) - hoverProgress.current) * 0.05;
